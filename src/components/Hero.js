...
export default function Hero() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[url('/img/bg/mobile-hero.webp')] md:bg-[url('/img/bg/itachi.png')] bg-no-repeat bg-top bg-cover md:bg-no-repeat md:bg-cover">
